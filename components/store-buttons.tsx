...
function PlayIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden="true">
      <path fill="#3DD9BD" d="M3.6 1.8 13.7 12 3.6 22.2c-.4-.3-.6-.8-.6-1.4V3.2c0-.6.2-1.1.6-1.4Z" />
      <path fill="#9BA3FF" d="m13.7 12 3.2-3.2 3.6 2.1c1.2.7 1.2 1.6 0 2.3l-3.6 2.1L13.7 12Z" />
      <path fill="#4F5BE8" d="M3.6 1.8c.4-.3 1-.3 1.6.1l11.7 6.9-3.2 3.2L3.6 1.8Z" />
      <path fill="#00A98F" d="M13.7 12 3.6 22.2c.4.4 1 .4 1.6.1l11.7-6.9-3.2-3.4Z" />
    </svg>
  );
}
...
function badgeClasses(disabled: boolean) {
  return [
    ...
    disabled
      ...
      : "border-line bg-surface hover:-translate-y-0.5 hover:border-indigo-bright/40 hover:shadow-[0_8px_40px_-12px_rgba(79,91,232,0.5)]",
  ].join(" ");
}
  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      >
        ...
        <span className="absolute -top-2 -right-2 rounded-full bg-teal-core px-2 py-0.5 text-[10px] font-semibold text-white">
          Soon
        </span>
      </span>
    </div>
